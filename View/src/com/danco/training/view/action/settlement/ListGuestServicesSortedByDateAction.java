...
public class ListGuestServicesSortedByDateAction implements IAction{
	...
	public Transmission sendCommand() {
		...
		try {
			...
			Object[] args = {((IHotelController) DependencyInjection.getInstance().getClassInstance(IHotelController.class)).getByIdGuest(InReader.readInt())};
			String methodName = "listGuestServicesSortedByDate";
