...
<title>Show count free rooms</title>
</head>
<body>
	...
	<center>
		<form action="../CountFreeRoomsServlet" method="post" class="form_from_content">
			<input type="submit" name="logon" class="login-button" value="Start action" />
		</form>
	</center>
</body>
</html>