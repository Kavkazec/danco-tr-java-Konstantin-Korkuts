...
<body>
	...
	<center>
		<form action="../SortedRoomServlet" method="get" class="form_from_content">
			<h2 class="form_name">Sort room:</h2></br></br></br>
			<legend>Which rooms?</legend>
			<input type="radio" name="rooms" value="Free">Free</br>
			<input type="radio" name="rooms" value="All">All</br>
			<legend>Sorted by:</legend>
			<input type="radio" name="sort" value="coast">coast</br>
			<input type="radio" name="sort" value="capacity">capasity</br>
   			<input type="radio" name="sort" value="numberOfStars">stars</br></br>
			<input type="submit" name="logon" class="login-button" value="Sort" />
		</form>
	</center>
</body>
</html>