...
<body>
	...
	<center>
		<form action="../AddGuestServlet" method="get" class="form_from_content">
			<h2 class="form_name">Add guest</h2></br></br></br></br></br></br>
				<input type="text" name="name" required placeholder="Input name" /></br>
				<input type="text" name="passportSeries" required placeholder="Input passport series" /></br>
				<input type="text" name="passportNumber" pattern="^[ 0-9]+$" required placeholder="Input passport number" /></br></br>
