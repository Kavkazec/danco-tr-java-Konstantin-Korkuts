...
<body>
	...
	<center>
		<form action="ChangeServiceResultServlet" method="get" class="form_from_content">
			<input type="text" name="id" value="${serviceEntity.getId()}" disabled /> </br>
			<input type="text" name="name" value="${serviceEntity.getName()}" disabled /> </br>
			<input type="text" name="coast" required placeholder="Input coast" /> </br>
			<input type="text" name="type" value="${serviceEntity.getType()}" disabled /> </br>
			<input type="text" name="settlement" value="${serviceEntity.getSettlement().getId()}" disabled /> </br>
			<input type="text" name="date" value="${serviceEntity.getDate()}" disabled /> </br>
