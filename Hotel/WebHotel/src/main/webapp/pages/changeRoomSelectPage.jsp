...
<body>
	...
	<center>
		<form action="ChangeRoomSelectServlet" method="get"
			class="form_from_content">
			<legend>Select criterion:</legend>
			<input type="radio" name="criterion" value="coast">Coast</br>
			<input type="radio" name="criterion" value="isOnRepair">On repair</br>
			<p>
