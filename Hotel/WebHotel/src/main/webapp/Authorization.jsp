...
<body align="center" class="fullbody">
	<div class="container">
		<form action="Authorization" method="post">
			...
			</br> <input type="submit" name="logon" class="login-button" value="Logon" />
			<input type="submit" name="registration" class="login-button"
				value="Registration" />
		</form>
		<form action="Registration" method="get"></form>
	</div>
</body>
</html>