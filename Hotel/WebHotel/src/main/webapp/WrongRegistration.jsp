	...
	<div class="container">
		<center>
			<form action="Registration" method="get">
				...
				<input type="password" name="password" required placeholder="Input password" /></br>
				<label for="password">Repeat password:</label>
				<input type="password" name="re_password" required placeholder="Repeat password" /></br></br>
