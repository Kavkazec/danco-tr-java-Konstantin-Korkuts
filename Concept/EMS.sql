...
CREATE TABLE IF NOT EXISTS student (id int(10) NOT NULL AUTO_INCREMENT, steward tinyint NOT NULL, groupe_id int(10) NOT NULL, user_id int(10) NOT NULL, interests varchar(100), status varchar(20) NOT NULL, study_start date NOT NULL, count_year int(1) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE IF NOT EXISTS verification (id int(10) NOT NULL AUTO_INCREMENT, student_id int(10) NOT NULL, subject_id int(10) NOT NULL, score int(2) NOT NULL, `date` date NOT NULL, PRIMARY KEY (id));
...
ALTER TABLE schedule ADD INDEX FKschedule98778 (groupe_id), ADD CONSTRAINT FKschedule98778 FOREIGN KEY (groupe_id) REFERENCES groupe (id);
